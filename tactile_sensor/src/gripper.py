...
class Robotiq_Two_Finger_Gripper(object):
    ...
    def half_open_gripper(self):
        self.gripper_action(128)

    def self_define_gripper(self, value):
        self.gripper_action(value)

    def close_gripper(self):
        self.gripper_action(round(255 * 0.99)) # 0.83 is the most appropriate value for the gripper

    def init_gripper(self):
        self.gripper_action(153)
